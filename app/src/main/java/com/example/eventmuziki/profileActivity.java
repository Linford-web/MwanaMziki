...
public class profileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // store review message in firestore using hash map
        submitReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(reviewMessage)) {
                    Toast.makeText(getApplicationContext(), "Please write a review", Toast.LENGTH_SHORT).show();
                    return;
                }

                AdvertisementDetails.reviewModel review = new AdvertisementDetails.reviewModel(reviewMessage, userId, timeStamp);
                ...
                fStore.collection("Users")
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(getApplicationContext(), "Error submitting review: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
